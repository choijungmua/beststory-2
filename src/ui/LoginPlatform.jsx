...
const LoginComponent = ({ platform }) => {
  ...
  return (
    <>
      {platform === "google" && (
        <button className="bg-white text-text rounded-[10px] max-sm:w-full gap-[10px] w-[500px] h-[50px] flex justify-center items-center shadow-md border border-tertiary">
          <img src={google} alt="" />
          <p>구글로 로그인</p>
        </button>
      )}
