...
const MainMiddle = () => {
    const notifications = Array(3).fill(null); // 길이가 4인 배열 생성
    return(
    ...
    <p className="text-[#323543] text-[36px] xl:text-[36px] lg:text-[30px] md:text-[30px] sm:text-[26px]">510개의 방</p>
    <Link to="/Room">
    <div className="flex bg-primary text-[20px] px-[20px] py-[10px] gap-[10px] justify-center items-center rounded-[10px] text-white 
 ...
 <Recommendation/>
 <Recommendation/>
 <div className="mt-[65px] mb-[25px] text-[#323543] text-[20px] lg:mt-[40px] lg:mb-[15px] lg:text-[16px]">
          <p>실시간 알림</p>
