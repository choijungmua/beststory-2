...
export default function Aside() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed px-[20px] py-[30px] right-0 w-[40vw] h-[100vh] bg-white z-20 max-sm:w-2/3 transition-transform duration-300 ${asideOpen ? 'animate-slideIn block' : 'animate-slideOut hidden'}`}
      >
        <div className='flex flex-col gap-[20px]'>
          ...
          <div className='w-full border border-tertiary rounded-[5px]'>
            <div className='flex border-b-2 border-tertiary h-[60px] gap-[2px] justify-center items-center'>
              <p className='text-[#323543]'>jkjk0192</p>
              <img src={Dog1} alt="Dog1" className='rounded-full w-[32px] h-[32px] border border-tertiary' />
            </div>
            <div className='flex h-[40px] text-[#323543]'>
              <div className='flex-1 gap-2 flex justify-center items-center'>
                <img src={alarm} alt="alarm" className='w-[14px] h-[17px]' />
                <p>알림</p>
              </div>
              <div className='flex-1 gap-2 flex justify-center items-center'>
                <img src={bookMark} alt="bookMark" className='w-[11px] h-[15px]' />
                <p>북마크</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-[#323543] flex flex-col gap-[10px]">
            <p>모든 목록</p>
            <p>소개</p>
            <p>공지</p>
          </div>
